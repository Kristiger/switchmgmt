...
public class Firewall {
    ...
    private static final int winWidth = 1220;
	private static final int winHeight = 419;
        ...
        shell.addListener(SWT.Close, new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                if (unsavedProgress) {
                    ...
                    messageBox
                            .setMessage("Are you sure you wish to exit the firewall? "
                ...
                if (rule != null) {
                    if (FirewallPusher.errorChecksPassed(table_rule.getItems())) {
                        ...
                        try {
                            ...
                            DisplayMessage.displayError(shell,"Problem pushing firewall rule. "
