...
public class ActionManagerJSON {
	...
	public static List<Action> getActions(String dpid, String flowName)
		...
		for(int i = 0; i < json.length(); i++){
			...
			if (!json.getJSONObject(i).getJSONObject(flowName).isNull("actions")) {
				jsonobj = json.getJSONObject(i).getJSONObject(flowName).getJSONObject("actions");
